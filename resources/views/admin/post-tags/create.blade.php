...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-4 mb-4">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Create Post Tag</h1>
        </div>
        <p class="text-gray-600">Tạo tag mới cho bài viết</p>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.post-tags.store') }}" method="POST" class="space-y-6">
        @csrf

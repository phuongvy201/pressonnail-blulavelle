            ...
            <div class="border-b border-gray-200 pb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <input type="number" name="delivery_min_days" value="{{ old('delivery_min_days', $shippingRate->delivery_min_days) }}"
                                       min="0"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                       placeholder="Min">
                            </div>
                            <div>
                                <input type="number" name="delivery_max_days" value="{{ old('delivery_max_days', $shippingRate->delivery_max_days) }}"
                                       min="0"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                       placeholder="Max">
                            </div>
                ...
                <div class="mt-4">
                    ...
                    <input type="text"
                           name="delivery_note"
                           id="delivery_note"
                           value="{{ old('delivery_note', $shippingRate->delivery_note) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"

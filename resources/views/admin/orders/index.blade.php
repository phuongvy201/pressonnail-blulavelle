                                                                        ...
                                                                        <div class="mt-2">
                                                                            ...
                                                                            <div class="space-y-1">
                                                                                @foreach($customizations as $key => $customization)
                                                                                    @php
                                                                                        $rawValue = is_array($customization) && isset($customization['value'])
                                                                                            ? $customization['value']
                                                                                            : $customization;
                                                                                        $displayValue = $rawValue;
                                                                                        $fileThumb = null;
                                                                                        // Nếu là JSON (file custom), xử lý đặc biệt
                                                                                        if (is_string($rawValue) && str_starts_with(ltrim($rawValue), '{')) {
                                                                                            ...
                                                                                            if (json_last_error() === JSON_ERROR_NONE && is_array($decoded)) {
                                                                                                ...
                                                                                                if (!empty($decoded['is_image']) && !empty($decoded['file_url'])) {
                                                                                                    $fileThumb = $decoded['file_url'];
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                        $displayValue = \Illuminate\Support\Str::limit((string) $displayValue, 50);
                                                                                    @endphp
                                                                                    @if(is_array($customization))
                                                                                        <div class="text-xs bg-blue-50 text-blue-800 px-2 py-1 rounded inline-flex items-center mr-1 mb-1">
                                                                                            @if($fileThumb)
                                                                                                <img src="{{ $fileThumb }}" alt="{{ $displayValue }}" class="w-8 h-8 rounded object-cover mr-1 border border-blue-200">
                                                                                            @endif
                                                                                            <span class="font-medium">{{ $key }}:</span>
                                                                                            <span class="ml-1">{{ $displayValue }}</span>
                                                                                            @if(isset($customization['price']) && $customization['price'] > 0)
                                                                                                <span class="text-green-600 font-medium ml-1">(+${{ number_format($customization['price'], 2) }})</span>
                                                                                            @endif
                                                                                        </div>
                                                                                       ...
                                                                                       class="text-xs bg-purple-50 text-purple-800 px-2 py-1 rounded inline-flex items-center hover:bg-purple-100 transition-colors">
                                                                                        @if($file->is_image)
                                                                                            <img src="{{ $file->file_url }}"
                                                                                                 ...
                                                                                                 class="w-8 h-8 rounded object-cover mr-1 border border-purple-200">

                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label class="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-3 cursor-pointer">
                            <input type="checkbox" name="requires_special_handling" value="1" {{ old('requires_special_handling') ? 'checked' : '' }} class="mt-1 h-4 w-4 rounded border-gray-300 text-amber-600 focus:ring-amber-500">
                            <span>

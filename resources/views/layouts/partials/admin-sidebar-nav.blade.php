...
@if ($__na)
    ...
    <details class="admin-nav-details mb-1" @if($navOpenOverview) open @endif>
        ...
        <div class="{{ $sub }}">
            ...
            <a href="{{ route('admin.virtual-nail-trials.index') }}" {!! $clk !!} class="{{ $ac(request()->routeIs('admin.virtual-nail-trials.*'), $m) }}">
            ...
            <a href="{{ route('admin.settings.virtual-nail.edit') }}" {!! $clk !!} class="{{ $ac(request()->routeIs('admin.settings.virtual-nail.*'), $m) }}">

...
$productListParams = [
    ...
    $q('sortBy', [
        'type' => 'string',
        'enum' => ['newest', 'price_asc', 'price_desc', 'name', 'popular', 'best_selling'],
        'default' => 'newest',
    ], 'Sort order'),
        ...
        'post' => $ops(
            ...
            $jsonBody([
                ...
                'properties' => [
                    ...
                    'shipping_zone_id' => ['type' => 'integer', 'minimum' => 1],
                    'payment_method' => ['type' => 'string', 'enum' => ['stripe', 'cod'], 'example' => 'stripe'],
                    'payment_ui' => ['type' => 'string', 'enum' => ['checkout_session', 'payment_sheet'], 'example' => 'checkout_session', 'description' => 'Select the Stripe-hosted Checkout Session flow for Expo Go/browser clients.'],
...
$cartExample = [
    ...
    'summary' => [
        ...
        'subtotal_after_bulk_discount' => 3998,
        'shipping' => 599,
        'discount' => 0,
        'gift_card_discount' => 0,
        'total' => 4597,
        'applied_promo_code' => null,
        'applied_gift_card_code' => null,
        'applied_gift_card_balance' => 0,
    ],
    'currency' => 'USD',
    'currency_rate' => 1,
];
...
$responseCatalog = [
    ...
    'POST /api/v1/cart/discount-mode' => [
        'data' => $ref('CartData'),
        'example' => $cartExample,
        'metaExample' => ['message' => 'Discount mode updated'],
    ],
...
$componentSchemas = [
    ...
    'CartData' => [
        ...
        'properties' => [
            ...
            'shipping_details' => ['type' => 'object', 'nullable' => true, 'additionalProperties' => true],
    ...
    'CartSummary' => [
        'type' => 'object',
        'description' => 'Cart totals for mobile Cart/Checkout. Volume and promo modes are mutually exclusive (freeship/gift card can still stack). Money fields are integer minor units.',
        'required' => [
            'discount_mode',
            'subtotal',
            'bulk_discount',
            'bulk_discount_percent',
            'subtotal_after_bulk_discount',
            'shipping',
            'discount',
            'gift_card_discount',
            'total',
        ...
        'properties' => [
            ...
            'bulk_discount' => [
                ...
                'description' => 'Volume/combo discount amount. 0 when mode is promo or no tier matched.',
            ],
            'bulk_discount_percent' => [
                'type' => 'number',
                'example' => 20,
            ...
            'discount' => [
                'allOf' => [['$ref' => '#/components/schemas/MoneyMinor']],
                'description' => 'Promo-code discount amount. 0 when mode is volume or no code applied.',
            ],
            ...
            'applied_promo_code' => [
                ...
                'nullable' => true,
                'example' => 'SAVE10',
                'description' => 'Applied promo code, or null when none.',
            ],
            'applied_gift_card_code' => ['type' => 'string', 'nullable' => true],
            'applied_gift_card_balance' => ['$ref' => '#/components/schemas/MoneyMinor'],
        ],
    ],
    'CheckoutSnapshot' => [
        'allOf' => [
    ...
    'CheckoutAttempt' => [
        ...
        'properties' => [
            ...
            'checkoutUrl' => ['type' => 'string', 'nullable' => true, 'description' => 'Stripe-hosted Checkout URL for browser clients.'],
